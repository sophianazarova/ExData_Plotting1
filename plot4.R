...
e_pow_sub$Global_reactive_power[e_pow_sub$Global_reactive_power == "?"] <- NA
e_pow_sub$Global_reactive_power <- as.numeric(e_pow_sub$Global_reactive_power)

e_pow_sub$Voltage[e_pow_sub$Voltage == "?"] <- NA
e_pow_sub$Voltage <- as.numeric(e_pow_sub$Voltage)
...
png("plot4.png")
par(mfrow=c(2,2))
plot(e_pow_sub$Time2, e_pow_sub$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

plot(e_pow_sub$Time2, e_pow_sub$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(e_pow_sub$Time2, e_pow_sub$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_rective_power")
